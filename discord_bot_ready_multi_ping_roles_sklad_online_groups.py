...
# 6) Для отслеживания игры Foxhole нужны включённые Intents в Discord Developer Portal:
...
def get_tracked_foxhole_players_by_group(guild):
    """
    Возвращает словарь:
...
async def update_online_embed_for_guild(guild, now_ts):
    ...
    players_by_group = get_tracked_foxhole_players_by_group(guild)
