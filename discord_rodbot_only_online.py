...
# Роли, которым разрешено использовать команду /онлайн
# Сюда вписывай ID ролей, которые могут выставлять канал/ветку онлайна.
ONLINE_SETTER_ROLE_IDS = [
    422500854910681089,   # Капитан
    1224787828815171595,  # Зам. капитана
]
...
ONLINE_ACTIVITY_GROUPS = [
    ...
    {"title": "С ролью заводчанин-строитель", "role_ids": [1241513032304295947]},
    {"title": "С ролью QRF", "role_ids": [1390688779056058429]},
    {"title": "С ролью Авиация", "role_ids": [1463925850654248991]},
]
